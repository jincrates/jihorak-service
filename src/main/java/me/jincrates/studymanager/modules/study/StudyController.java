...
import me.jincrates.studymanager.modules.study.validator.StudyFormValidator;
import me.jincrates.studymanager.modules.study.form.StudyForm;
...
public class StudyController {
    ...
    public String newStudySubmit(@CurrentAccount Account account, @Valid StudyForm studyForm, Errors erros, Model model) {
        if (erros.hasErrors()) {
            model.addAttribute(account);
            return "study/form";
        }
