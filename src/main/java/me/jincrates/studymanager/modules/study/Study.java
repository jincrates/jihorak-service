...
public class Study {
    ...
    private LocalDateTime recruitingUpdatedAt;
    ...
    public boolean canUpdateRecruiting() {
        return this.published && this.recruitingUpdatedAt == null || this.recruitingUpdatedAt.isBefore(LocalDateTime.now().minusHours(1));
    }

    public void startRecruit() {
        if (canUpdateRecruiting()) {
            this.recruiting = true;
            this.recruitingUpdatedAt = LocalDateTime.now();
        } else {
            throw new RuntimeException("인원 모집을 시작할 수 없습니다. 스터디를 공개하거나 1시간 뒤 다시 시도하세요.");
        }
    }
    ...
    public void stopRecruit() {
        if (canUpdateRecruiting()) {
            ...
            throw new RuntimeException("인원 모집을 멈출 수 없습니다. 스터디를 공개하거나 1시간 뒤 다시 시도하세요.");
        }
    }
