...
import me.jincrates.studymanager.modules.study.event.StudyCreatedEvent;
import me.jincrates.studymanager.modules.study.event.StudyUpdateEvent;
import me.jincrates.studymanager.modules.study.form.StudyDescriptionForm;
...
import static me.jincrates.studymanager.modules.study.form.StudyForm.VALID_PATH_PATTERN;
...
public class StudyService {
    ...
    private void checkIfManager(Account account, Study study) {
        if (!study.isManagedBy(account)) {  //해당 메소드는 스터디쪽에 만들 수도 있다.
