...
import me.jincrates.studymanager.modules.account.form.Notifications;
import me.jincrates.studymanager.modules.account.form.Profile;
...
public class AccountService implements UserDetailsService {
    ...
    public void sendSignUpConfirmEmail(Account newAccount) throws MessagingException {
        ...
        context.setVariable("message", "지호락 서비스를 사용하려면 링크를 클릭하세요.");
    ...
    public void updateProfile(Account account, Profile profile) {
        ...
        accountRepository.save(account);  // accountRepository.save를 하지 않으면 영속성 컨텍스트 관리를 받지 못함
    }
    ...
    public void sendLoginLink(Account account) {
        ...
        context.setVariable("linkName", "지호락 로그인하기");
